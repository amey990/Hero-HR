...
export default function LoginPage() {
  const [email, setEmail] = useState("commedia9900@gmail.com");
  ...
  return (
    <>
      <style>{`
        ...
        :global(.dark) .remember-checkbox {
          border-color: rgba(255, 255, 255, 0.1);
          background: rgba(255, 255, 255, 0.05);
        }

        :global(.dark) .remember-checkbox.checked {
          background: #8b5cf6;
          border-color: #8b5cf6;
        }
        ...
        :global(.dark) .signin-btn {
          background: #8b5cf6;
          color: #ffffff;
        }

        :global(.dark) .signin-btn:hover {
          background: #7c3aed;
          box-shadow: 0 8px 24px rgba(139, 92, 246, 0.3);
        }

        :global(.dark) .signin-btn:disabled {
          background: #1a1a28;
          color: #3a3a55;
        }

        :global(.dark) .admin-login-btn {
          background: rgba(255, 255, 255, 0.05);
          border-color: rgba(255, 255, 255, 0.08);
          color: #c0c0e0;
        }

        :global(.dark) .admin-login-btn:hover {
          background: rgba(255, 255, 255, 0.08);
          ...
          <div className="login-form-section">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <button
                  type="button"
                  className="admin-login-btn flex-1"
